"""Exponential moving average of the diffusion transformer weights.

The shadow copy is kept on CPU by default and swapped in for sampling and
checkpointing; ``modify_to_inference`` / ``modify_to_train`` bracket that swap.
"""
